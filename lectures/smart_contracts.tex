...
\end{block}
\end{columns}
\bottomnote{Section 1 of 5 | Frames 4--20}
\end{frame}
...
\begin{frame}{}
\begin{beamercolorbox}[sep=12pt,center,rounded=true,shadow=true]{palette quaternary}
  {\Large\bfseries Section 3: Smart Contracts in Business \& Finance}\\[6pt]
...
\end{block}
\end{columns}
\bottomnote{Section 3 of 5 | Frames 21--37}
\end{frame}
...
\begin{frame}{}
\begin{beamercolorbox}[sep=12pt,center,rounded=true,shadow=true]{palette quaternary}
  {\Large\bfseries Section 4: How Smart Contracts Work Under the Hood}\\[6pt]
...
\end{block}
\end{columns}
\bottomnote{Section 4 of 5 | Frames 38--52}
\end{frame}

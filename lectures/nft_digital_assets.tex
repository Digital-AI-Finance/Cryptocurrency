...
\begin{enumerate}
\item \textbf{Explain} the ERC-721 and ERC-1155 token standards and their metadata architecture
\item \textbf{Compare} NFT marketplace mechanisms (auction, fixed price, AMM-based)
\item \textbf{Analyze} NFT valuation methods including rarity scoring and floor price analysis
\item \textbf{Evaluate} NFT use cases beyond art (gaming, identity, RWA, ticketing)
\item \textbf{Assess} advanced NFT concepts (fractional, dynamic, soulbound tokens)
\end{enumerate}

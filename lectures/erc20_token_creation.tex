...
{\Large\bfseries Section 1: Token Standards}\\[6pt]
{\normalsize What tokens are, why standards matter, and the ERC-20 ecosystem}
\end{beamercolorbox}
\end{frame}
...
\begin{frame}{Section 1 Summary: Key Numbers}
  ...
  \begin{tikzpicture}[font=\small]
    ...
    % Card 3: 2
    \node[statcard, fill=mlorange!20, draw=mlorange] (c3) at (0,-3.0) {};
    \node[font=\Huge\bfseries, text=mlorange!80!black] at (0,-2.45) {2};
    \node[font=\small, text=mlorange!70!black] at (0,-3.30) {Required Events};
    \node[font=\tiny, text=mlgray] at (0,-3.75) {Transfer and Approval};

    % Card 4: 2015
    \node[statcard, fill=mlpurple!20, draw=mlpurple] (c4) at (5.2,-3.0) {};
    \node[font=\Huge\bfseries, text=mlpurple] at (5.2,-2.45) {2015};
    \node[font=\small, text=mlpurple!80!black] at (5.2,-3.30) {Year Proposed};
    \node[font=\tiny, text=mlgray] at (5.2,-3.75) {EIP-20 by Fabian Vogelsteller};
  \end{tikzpicture}
  \end{center}
...
{\normalsize Hands-on: Creating a complete ERC-20 token}
\end{beamercolorbox}
\end{frame}
...
\begin{frame}{Distribution Visualization}
  ...
  \begin{tikzpicture}[scale=1.0]
    ...
    % Legend row below
    \fill[mlblue!70] (-3.6, -2.7) rectangle (-3.35, -2.45);
    \node[font=\tiny, anchor=west] at (-3.3, -2.575) {Team (20\%)};
    \fill[mlorange!70] (-2.38, -2.7) rectangle (-2.13, -2.45);
    \node[font=\tiny, anchor=west] at (-2.08, -2.575) {Investors (15\%)};
    \fill[mlgreen!70] (-1.16, -2.7) rectangle (-0.91, -2.45);
    \node[font=\tiny, anchor=west] at (-0.86, -2.575) {Public (20\%)};
    \fill[mlred!70] (0.06, -2.7) rectangle (0.31, -2.45);
    \node[font=\tiny, anchor=west] at (0.36, -2.575) {Community (15\%)};
    \fill[mlpurple!70] (1.28, -2.7) rectangle (1.53, -2.45);
    \node[font=\tiny, anchor=west] at (1.58, -2.575) {Ecosystem (25\%)};
    \fill[mlgray!60] (2.50, -2.7) rectangle (2.75, -2.45);
    \node[font=\tiny, anchor=west] at (2.80, -2.575) {Liquidity (5\%)};
  \end{tikzpicture}
  \end{center}

...
\begin{center}
\begin{tikzpicture}
  \node[draw,fill=mlorange,text=white,rounded corners=8pt,
        minimum width=13cm,minimum height=1.2cm,align=center,
        font=\large\bfseries]
        at (0,3.2) {How DAOs manage billions in assets and design sustainable token economies};
\end{tikzpicture}
\end{center}
\vspace{2mm}
\begin{columns}[T]
...
\begin{center}
\begin{tikzpicture}
  \node[draw,fill=mlred,text=white,rounded corners=8pt,
        minimum width=12cm,minimum height=1.4cm,align=center,font=\Large\bfseries]
        at (0,1.8) {Section 4: Governance Attacks \& Security};
  \node[draw,fill=mlred!20,rounded corners=6pt,
        minimum width=12cm,minimum height=0.9cm,align=center,font=\normalsize]
        at (0,0.5) {Understanding and defending against threats to decentralized governance};
\end{tikzpicture}
...
\begin{center}
\begin{tikzpicture}
  \node[draw,fill=mlblue,text=white,rounded corners=8pt,
        minimum width=12cm,minimum height=1.4cm,align=center,font=\Large\bfseries]
        at (0,1.8) {Section 5: Real-World DAOs \& Future of Governance};
  \node[draw,fill=mlblue!20,rounded corners=6pt,
        minimum width=12cm,minimum height=0.9cm,align=center,font=\normalsize]
        at (0,0.5) {Case studies, participation challenges, and the road ahead};
\end{tikzpicture}

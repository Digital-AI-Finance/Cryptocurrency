...
\begin{enumerate}
\item \textbf{Classify} stablecoins by collateral type (fiat-backed, crypto-backed, algorithmic)
\item \textbf{Analyze} peg mechanisms and the conditions under which de-peg events occur
\item \textbf{Explain} the Terra/LUNA death spiral and lessons for algorithmic stablecoin design
\item \textbf{Compare} CBDC architectures (wholesale vs.\ retail, account vs.\ token-based)
\item \textbf{Evaluate} the regulatory landscape and systemic risks of stablecoins in DeFi
\end{enumerate}

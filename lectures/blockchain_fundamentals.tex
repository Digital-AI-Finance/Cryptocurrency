...
\addplot[mlblue,thick,domain=0:40,samples=80] {1-exp(-10^(x-24)/2)};
\addlegendentry{$n=80$}
...
\node[draw,fill=mllavender2,rounded corners,font=\small\bfseries] {Root\\$H_{1234}$}
...
\begin{tikzpicture}[font=\tiny,node distance=0.5cm]
  \node[draw,fill=mllavender2,rounded corners,minimum width=2.5cm] (root) at (3,5.2) {Root Node\\(Extension)};
  \node[draw,fill=mllavender3,rounded corners,minimum width=2.0cm] (branch) at (3,4.0) {Branch Node\\[16 slots]};
  \node[draw,fill=mllavender4,rounded corners,minimum width=1.8cm] (leaf1) at (1.0,2.8) {Leaf: addr A\\bal: 5 ETH};
  \node[draw,fill=mllavender4,rounded corners,minimum width=1.8cm] (leaf2) at (3.0,2.8) {Leaf: addr B\\bal: 2 ETH};
  \node[draw,fill=mllavender4,rounded corners,minimum width=1.8cm] (leaf3) at (5.0,2.8) {Leaf: addr C\\bal: 0 ETH};
...
\begin{tikzpicture}[
  ...
  \draw[->,mlpurple,thick] (dep)--(pend) node[midway,above,font=\tiny]{deposit\\processed};
  \draw[->,mlpurple,thick] (pend)--(act) node[midway,above,font=\tiny]{queue\\cleared};
  \draw[->,mlpurple,thick] (act)--(exit) node[midway,above,font=\tiny]{voluntary\\exit};
  \draw[->,mlpurple,thick] (exit)--(with) node[midway,above,font=\tiny]{withdrawal\\delay};
  \draw[->,mlred,thick] (act)--(slash) node[midway,right,font=\tiny]{slashing\\condition};
...
\begin{tikzpicture}[font=\tiny]
  ...
  \node[draw,fill=mlred!20,rounded corners,minimum width=2.5cm] (b1) at (1.5,2.8) {Vote for Block A\\slot 100};
  \node[draw,fill=mlred!20,rounded corners,minimum width=2.5cm] (b2) at (4.5,2.8) {Vote for Block B\\slot 100};
  ...
  \node[draw,fill=mlred!40,rounded corners,minimum width=3cm] (slash) at (3,1.2) {SLASHABLE OFFENSE:\\Double Vote Detected};
...
\begin{tikzpicture}[font=\tiny]
  ...
  \node[draw,fill=mllavender4,rounded corners,minimum width=2cm] (f1) at (1.2,3.0) {Fork A\\(chain 1)};
  \node[draw,fill=mllavender4,rounded corners,minimum width=2cm] (f2) at (4.8,3.0) {Fork B\\(chain 2)};
  \node[draw,fill=mlorange!30,rounded corners,minimum width=1.5cm] (val) at (3,1.5) {Validator\\votes BOTH};
...
%--- FRAME 42: Full Nodes vs Light Clients ---
...
\begin{tikzpicture}[font=\small]
  ...
  \node[draw,circle,fill=mlred!30,minimum size=1cm] (g3) at (4.5,1.5) {G3\\\tiny(traitor)};

...
\textbullet~\textbf{Von Neumann Architecture:} Invented the \emph{stored-program} design --- a single memory holds both instructions and data, connected to a CPU via a shared bus. This is the blueprint for virtually every computer ever built, including every blockchain node running today.\\[2pt]
